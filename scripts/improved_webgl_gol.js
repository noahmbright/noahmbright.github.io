(function(){
    ...
    const grid_fragment_source = `#version 300 es
        ...
        void main(){
            ...
            // this_section_id has different even/odd parity for adjacent cells so they can
            // be dyed differently
            int this_section_id = this_section_coord.x + this_section_coord.y;
            vec4 dye_color = ((this_section_id & 1) == 1)
